...
function llenarTablas() {
    const horariosSalidaMañana = generarHorarios(4, 58, 11, 59, 12); // Desde las 5:12 AM hasta las 12:12 PM
    const horariosSalidaTarde = generarHorarios(12, 10, 18, 59, 12); // Desde las 12:12 PM hasta las 7:12 PM
    const horariosSalidaNoche = generarHorarios(19, 10, 23, 34, 12); // Desde las 7:12 PM hasta las 11:12 PM

    const horariosLlegadaMañana = generarHorarios(4, 46, 11, 59, 12); // Desde las 6:12 AM hasta las 12:12 PM
    const horariosLlegadaTarde = generarHorarios(12, 10, 18, 59, 12); // Desde las 1:12 PM hasta las 7:12 PM
    const horariosLlegadaNoche = generarHorarios(19, 10, 23, 46, 12); // Desde las 7:12 PM hasta las 11:12 PM
